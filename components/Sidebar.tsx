  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-[280px] flex flex-col border-r border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-950 overflow-y-auto z-40">
      ...
      <div className="flex flex-col items-center text-center px-6 pt-10 pb-6">
        ...
        <h1 className="text-base font-bold text-stone-900 dark:text-white">{siteConfig.name}</h1>
        <p className="text-xs text-stone-500 dark:text-stone-400 mt-1">{siteConfig.title}</p>
        <p className="text-xs text-stone-400 dark:text-stone-500 mt-2 leading-relaxed">{siteConfig.tagline}</p>
      </div>
